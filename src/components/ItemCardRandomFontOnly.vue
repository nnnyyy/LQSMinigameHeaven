<template>
    <div id="ItemCardRandom">
        <div class="title pdtb8 reverse-color">랜덤 폰트 아이템 {{reqGP}} GP</div>
        <div class="botline"/>
        <div class="mgtb8 fs90">
            폰트를 노리는 자. 꽝을 조심하라.          
        </div>
        <div class="topline"/>
        <div class="mgtb8" style="height: 50px; text-align: center; overflow-y: scroll;">
        ...
        methods: {            
            onBuy() {
                ...
                this.G.setProcBuy( true );
                 ...
                 this.G.hget(P.http.OpenFontGachaRand, data=> {
                    if( data.ret === 0 ) {
